...
export async function seedPromoDemo(
  ...
  return {
    routes: {
      ...
      dashboard: "/dashboard",
      quoteId: quote.id,
      quoteUrl: `/dashboard/quotes/${quote.id}`,
      orderId: order.id,
      orderUrl: `/dashboard/orders/${order.id}`,
      invoiceSentId: invoiceSent.id,
      invoiceSentUrl: `/dashboard/invoices/${invoiceSent.id}`,
      expensePendingId: expensePending.id,
      expenseUrl: `/dashboard/expenses/${expensePending.id}`,
      reimbursementId: reimbursement.id,
      reimbursementUrl: `/dashboard/reimbursements/${reimbursement.id}`,
      inboundEmailUrl: "/dashboard/inbound-email",
      transactionsUrl: "/dashboard/transactions",
