...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive guides to UK financial requirements, record keeping, and tax obligations. Learn about Companies House filings, Corporation Tax, Self Assessment, VAT, and statutory accounts. Essential information for UK limited companies and sole traders to stay compliant with HMRC and Companies House.",
  keywords: [
    "UK financial requirements",
    "UK limited company obligations",
    "UK sole trader requirements",
    "Companies House filing",
    "UK Corporation Tax",
    "UK Self Assessment",
    "UK VAT requirements",
    "UK record keeping requirements",
    "UK tax obligations",
