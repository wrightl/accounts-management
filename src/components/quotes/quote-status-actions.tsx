    ...
    async function runTransition(target: QuoteStatus) {
        ...
        if (target === 'draft' && status === 'declined') {
            const reopened = await confirm({
                title: 'Reopen quote',
                message:
                    'Reopen this quote for editing? Decline details will be cleared.',
                confirmLabel: 'Reopen',
            });
            if (!reopened) return;
        }
            ...
            >
                ...
                >
                    <div>
                        ...
                        <FieldError id="decline-category-error">
                            {fieldErrors.category}
                        </FieldError>
                    </div>
                    {category === '__custom__' ? (
                    ...
                    <div>
                        ...
                        />
                        <FieldError id="decline-narrative-error">
                            {fieldErrors.narrative}
                        </FieldError>
                    </div>
